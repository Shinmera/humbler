...
(defvar *blog/likes* "https://api.tumblr.com/v2/blog/~a.tumblr.com/")
(defvar *blog/followers* "https://api.tumblr.com/v2/blog/~a.tumblr.com/")

(defun blog/info (username)
  (request (format NIL *blog/info* username) :parameters `(("api_key" . ,south:*oauth-api-key*))))

(defun blog/avatar (username &key (size 64) (fetch T))
...
(defun blog/likes (username &key (limit 20) (offset 0))
  ...
  (request (format NIL *blog/likes* username) :parameters (prepare* limit offset)))
...
(defun blog/followers (username &key (limit 20) (offset 0))
  ...
  (assert (<= 0 offset)
          () "Offset must be positive.")
  (request (format NIL *blog/followers* username) :parameters (prepare* limit offset)))
